            ...
            <?php
                ...
                <div class="row">
                            ...
                            if ($categories) {
                                if (mysqli_num_rows($categories) > 0) {
                                    foreach ($categories as $cateItem) {
                                        ...
                                        <option 
                                            value="<?=$cateItem['id'];?>"
                                            <?= $productData['data']['category_id'] == $cateItem['id'] ? 'selected':''; ?>
                                             > 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="quantity" required value="<?= $productData['data']['quantity']; ?>" class="form-control" />
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="">Image *</label>
                        <input type="file" name="image" class="form-control" />
                        <img src="../<?= $productData['data']['image']; ?>" style="width: 50px; height: 50px" alt="">
                    </div>
                    <div class="col-md-6">
