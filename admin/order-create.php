  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
            <label for="">Eneter Csutomer Name</label>
            <input type="text" class="form-control" id="c_name" name="customer" />
        </div>
        <div class="mb-3">
            <label for="">Eneter Csutomer Phone no</label>
            <input type="number" class="form-control" id="c_phone" name="customer" />
        </div>
        <div class="mb-3">
            <label for="">Eneter Csutomer Email(optional)</label>
            <input type="email" class="form-control" id="c_email" name="customer" />
        </div>
      </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="" id="cphone" class="form-control" value="" />
                        </div>
                        <div class="col-md-4">
                            <br>
