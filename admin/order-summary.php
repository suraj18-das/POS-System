                ...
                <div class="card-body">
                    ...
                    <div id="myBillingArea">
                        ...
                        if (isset($_SESSION['cphone'])) {
                            ...
                            $customeQuery = mysqli_query($conn, "SELECT * FROM customers WHERE phone= '$phone' LIMIT 1 ");
                            if ($customeQuery) {
                                if (mysqli_num_rows($customeQuery) > 0) {
                                    $cRowData = mysqli_fetch_assoc($customeQuery);
                        ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: center;" colspan="2">
                                                    ...
                                                    <p style="font-size: 16px; line-height: 24px; margin: 2px; padding: 0;">company xyz pvt lt</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td align="end">
                                                    ...
                                                    <p style=" font-size:14px; line-height:20px; margin:0px; padding: 0;">Invoice No: <?= $invoice_no; ?></p>
